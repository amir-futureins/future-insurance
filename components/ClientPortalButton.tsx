  ...
  return (
    <>
      <button
        ...
        className="hidden items-center gap-1.5 rounded-xl border border-amber-400/50 bg-[#142B55] px-3.5 py-2 text-[14px] font-bold text-white shadow-sm ring-1 ring-amber-400/15 transition-colors hover:bg-[#1c3a70] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-gold-bright sm:inline-flex"
      >
