...
export default function SocialProofToast() {
  ...
  return (
    <div className="no-print pointer-events-none fixed bottom-[calc(env(safe-area-inset-bottom)_+_17.5rem)] end-4 z-40 hidden w-[min(20rem,calc(100vw-6rem))] md:block lg:bottom-44">
