  ...
  return (
    <div className="no-print">
      <button
        ...
        className="fixed bottom-20 start-4 z-[70] grid h-[52px] w-[52px] place-items-center rounded-full bg-cta-fill text-navy-deep shadow-xl shadow-navy/25 ring-2 ring-white/60 transition-transform hover:scale-105 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-gold-deep lg:bottom-5 lg:start-5"
      >
      ...
      {open && (
        <>
          ...
          <div
            ...
            className="glass-elevated fixed bottom-20 start-4 z-[71] max-h-[70vh] w-[min(20rem,calc(100vw-2rem))] overflow-y-auto p-4 outline-none lg:bottom-5 lg:start-5"
            dir="rtl"
          >
